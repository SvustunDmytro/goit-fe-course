...
const addListItem = event => {
  ...
  noteList.append(notepad.createListItem(listItem));
...
const filterNotes = event => {
  ...
  notepad.renderNoteList(noteList, filtredItem);
}
...
noteList.addEventListener('click', deleteListItem);
searchForm.addEventListener('input', filterNotes);